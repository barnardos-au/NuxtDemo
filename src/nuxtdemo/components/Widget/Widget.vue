...
export default {
  ...
  mounted() {
    ...
    if (this.customControls) {
      const close = this.$refs.customControlsRef.querySelector(
        '[control=close]'
      )
      close && close.addEventListener('click', this.closeWidget)
      const collapse = this.$refs.customControlsRef.querySelector(
        '[control=collapse]'
      )
      collapse &&
      ...
      const expand = this.$refs.customControlsRef.querySelector(
        '[control=expand]'
      )
      expand &&
      ...
      const fullscreen = this.$refs.customControlsRef.querySelector(
        '[control=fullscreen]'
      )
      fullscreen &&
      ...
      const restore = this.$refs.customControlsRef.querySelector(
        '[control=restore]'
      )
      restore &&
