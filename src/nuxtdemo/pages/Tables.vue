<template>
  <div class="tables-basic">
    <h2 class="page-title">
      Tables - <span class="fw-semi-bold">Static</span>
    </h2>
    <b-row>
      <b-col>
        <Widget
          ...
          <table class="table table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  Jacob
                  <b-badge variant="warning" class="text-gray-dark"
                    >ALERT!</b-badge
                  >
                </td>
                <td>Thornton</td>
            ...
            <table class="table table-hover">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <b-badge variant="gray" class="text-gray" pill
                      >Pending</b-badge
                    >
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <b-badge variant="gray" class="text-gray-light" pill
                      >Unconfirmed</b-badge
                    >
                  </td>
                </tr>
      ...
      <b-col lg="6">
        ...
        >
          ...
          <p>
            ...
            Awesome look for no cost. Just wrap the table with simple css class
                  ...
                  <td>
                    <div class="abc-checkbox">
                      <input
                        ...
                        @change="
                          (event) => changeCheck(event, 'checkboxes3', 1)
                        "
                      />
                  ...
                  <td>
                    <div class="abc-checkbox">
                      <input
                        ...
                        @change="
                          (event) => changeCheck(event, 'checkboxes3', 2)
                        "
                      />
                  ...
                  <td>
                    <div class="abc-checkbox">
                      <input
                        ...
                        @change="
                          (event) => changeCheck(event, 'checkboxes3', 3)
                        "
                      />
                  ...
                  <td>
                    <div class="abc-checkbox">
                      <input
                        ...
                        @change="
                          (event) => changeCheck(event, 'checkboxes3', 4)
                        "
                      />
                  ...
                  <td>
                    <div class="abc-checkbox">
                      <input
                        ...
                        @change="
                          (event) => changeCheck(event, 'checkboxes3', 5)
                        "
                      />
...
export default {
  ...
  methods: {
    ...
    getRandomColor() {
      const { primary, success, info, danger } = {
        sidebar: '#002B49',
        navbar: '#ffffff',
        primary: '#005792',
        secondary: '#798892',
